const flashcards = [
  ...
  },
  {
    ...
    table: `
      ...
      <p class="rule"><b>✅ Rule:</b> Use <i>the</i> only when you specify (e.g., “The breakfast at the hotel was delicious”).</p>
    `
  },
  {
    ...
    table: `
      ...
      <p class="rule"><b>✅ Rule:</b> Don’t use <i>the</i> after <i>by</i> when talking about transport.</p>
    `
  }
];
